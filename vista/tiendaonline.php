                                            ...
                                            <div class="feature-product-item">
                                                <div class="product-thumb">
                                                    ...
                                                    <div class="add-to-links">
                                                        <a href="account/login-register" data-bs-toggle="tooltip"
                                                            title="Añadir al carrito"><i class="ion-bag"></i></a>
                                                        <a href="details/details?id=<?php echo $row['id_prod']; ?>"
                                ...
                                ORDER BY id_prod DESC LIMIT 5';
                                        foreach ($db->query($sql) as $row) {
                                            ...
                                            <div class="feature-product-item">
                                                <div class="product-thumb">
                                                    <a href="#"><img
                                                            src="../../vetdog/assets/img/subidas/<?php echo $row['foto']; ?>"
                                                            alt=""></a>
                                                    <div class="add-to-links">
                                                        <a href="account/login-register" data-bs-toggle="tooltip"
                                                            title="Añadir al carrito"><i class="ion-bag"></i></a>
                                                        <a href="details/details?id=<?php echo $row['id_prod']; ?>"><span
                                                                data-bs-toggle="tooltip" title="Ver"><i
                                                                ...
                                                                <div class="product-item">
                                                                    <div class="product-thumb">
                                                                        ...
                                                                        <div class="product-badge product-badge__2">
                                                                            <div class="product-label new"><span>Nuevo</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="product-content">
                                                                        <div class="product-name">
                                                                            <h5><a href="#"><?php echo $row['nompro']; ?></a>
                                                                            </h5>
                                                                        </div>
                                                                        <div class="ratings">
                                                                            <span><i class="ion-android-star"></i></span>
                                                                        ...
                                                                        <div class="price-box">
                                                                            <span
                                                                                class="price-regular">$/<?php echo $row['precV']; ?></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <?php
